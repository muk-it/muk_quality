...
This quality management module installs a implementation of a controlled document according to ISO-9001. In addition to documents, templates can also be created to facilitate the workflow. The stages of a document can be set individually.
